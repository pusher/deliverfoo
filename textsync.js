/*! TextSync client (development build) version 61d1584bcc7058b05714b0e12e5b97f0d95983ee */
...
var TextSync = (function () {
    ...
    TextSync.prototype.start = function (adaptor) {
        ...
        this.initDocument().then(function (res) {
    ...
    TextSync.prototype.subscribe = function (name, email, subscribeFromId) {
        ...
        this.subscription = this.pusher.resumableSubscribe({
            path: path,
            lastEventId: subscribeFromId,
